  ...
  <div class="flex flex-wrap">
    ...
    <div>
      ...
      <b-button v-b-modal.modal-1 @click="showModal = true" variant="light">
        ...
        >
          <path
            d="M15.996 1.004c-.917 0-1.727.378-2.244.959A3.045 3.045 0 0 0 13 4c0
          .722.235 1.456.752 2.037s1.327.961 2.244.961a8.959 8.959 0 0 1 9.006
          9.006c0 5.01-3.994 8.998-9.006 8.998-.917 0-1.727.378-2.244.959A3.05
          3.05 0 0 0 13 28c0 .722.235 1.456.752 2.037s1.327.96 2.244.96c8.252 0
          15-6.74 15-14.993s-6.747-15-15-15zM9.832 7.006a3.013 3.013 0 0 0-2.834
          2.996v1.004H4.002a3.012 3.012 0 0 0-2.998 2.998v3.992a3.012 3.012 0 0
          0 2.998 2.998h2.996v1.004c0 2.412 2.875 3.845 4.805
          2.398l8.002-6.001c1.577-1.184 1.577-3.608 0-4.791l-8.002-6a3.011 3.011
          0 0 0-1.971-.598z"
