  ...
  <main class="" v-if="loaded == 'OK'">
    ...
    <section class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 lg:py-20">
      <ul role="list" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
        <li
          ...
          class="relative"
          style="
            background-image: url('https://images.pexels.com/photos/3738673/pexels-photo-3738673.jpeg?auto=compress&cs=tinysrgb&h=350');
    ...
    <section class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 lg:py-20">
      <ul role="list" class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
        ...
        <li
          class="relative bg-gray-100 m-auto w-auto mt-5"
          style="
            background-image: url('https://picsum.photos/537/350');
            background-position: center;
            background-repeat: no-repeat;
            background-size: cover;
          "
        >
          <div class="flex flex-row items-end h-full w-full">
            ...
            >
              <h3 class="text-base font-bold leading-5 uppercase">
                Lorun, ipsum dolor sit amet elit foure consectetur adipisicing.
              </h3>
              <div class="inline-flex items-center">
                <span class="capitalize font-base text-xs my-1 mr-1"
                  >Agnezmo Tuginem</span
        ...
        <li class="relative">
          <div
            class="block overflow-hidden w-full group aspect-w-10 aspect-h-7"
          >
            <img
            ...
            <div class="flex-grow flex flex-col justify-center p-12">
              ...
              <div class="md:pl-16 pl-0">
                ...
                <p class="sm:text-xl text-gray-600 mt-3 leading-relaxed">
                  The file you're looking at is the
                  <span
                    class="font-mono bg-gray-200 text-sm sm:text-base text-gray-700 subpixel-antialiased px-1 rounded"
                    >index.html</span
                  >
                  file in the repository you just cloned. If you used
                  <span
                    class="font-mono bg-gray-200 text-sm sm:text-base text-gray-700 subpixel-antialiased px-1 rounded"
                    >npm run serve</span
                  >
                  to view this page, try editing that file to see this page
                  ...
                  <div class="flex flex-grow">
                    ...
                    <div class="leading-relaxed flex flex-col ml-4 md:ml-6">
                      ...
                      <p class="text-gray-600 mt-1 text-sm md:text-base">
                        Get familiar with Tailwind’s utility-first approach and
                ...
                >
                  <div class="flex flex-grow">
                    ...
                    <div class="flex flex-col leading-relaxed ml-4 md:ml-6">
                      ...
                      <p class="text-gray-600 mt-1 text-sm md:text-base">
                        Browse pre-built components using Tailwind’s utility
                        classes.
                      </p>
                      <div class="pt-1 mt-auto">
                        <a
                ...
                >
                  <div class="flex flex-grow">
                    ...
                    <div class="flex flex-col leading-relaxed ml-4 md:ml-6">
                      ...
                      <p class="text-gray-600 mt-1 text-sm md:text-base">
                        A collection of assets and resources to help supercharge
                ...
                >
                  <div class="flex flex-grow">
                    ...
                    <div class="flex flex-col leading-relaxed ml-4 md:ml-6">
                      ...
                      <p class="text-gray-600 mt-1 text-sm md:text-base">
                        Connect and learn from other Tailwind users in the
                        community.
                      </p>
                      <div class="pt-1 mt-auto">
                        <a
